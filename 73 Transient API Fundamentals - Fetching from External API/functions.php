...
set_transient("my_transient", "Mahadev Shambhu Shankar", 3600);


/* Using Transient API to Cache an External API using Transients */

function get_cached_external_api_data()
{
    ...
    // Store in Transient for 12 Hours (60*60*12 = 43200seconds)
