...
class ReactImageUploader
{
    ...
    public static function activate()
    {
        ...
        $sql_react_multiple_images = "CREATE TABLE $table (
    ...
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP
        ...
        dbDelta($sql_react_multiple_images);
    }
    ...
    public function handle_save_gallery()
    {
        ...
        global $wpdb;
        $table_react_images = $wpdb->prefix . 'riu_gallery';
        ...
        foreach ($images as $url) {
            $wpdb->insert($table_react_images, ['image_url' => esc_url_raw($url)]);
        }
